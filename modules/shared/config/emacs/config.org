...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Tomasz Wostal"
    user-mail-address "tomasz@wostal.eu")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/twostal/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/twostal/bin" "/profile/bin" "/Users/twostal/.npm-packages/bin" "/Users/twostal/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
